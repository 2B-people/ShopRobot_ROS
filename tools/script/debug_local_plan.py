...
if __name__ == "__main__":
    ...
    # 格式(位置,分数,东西)
    goods_client.call(0, 1, 9)
    goods_client.call(1, 1, 1)
    goods_client.call(2, 2, 6)
    goods_client.call(3, 3, 4)
    goods_client.call(4, 0, 3)
    goods_client.call(5, 0, 12)
    goods_client.call(6, 0, 7)
    goods_client.call(7, 0, 10)
    goods_client.call(8, 0, 8)
    goods_client.call(9, 0, 2)
    goods_client.call(10, 0, 5)
    goods_client.call(11, 0, 11)
