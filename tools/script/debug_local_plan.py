...
if __name__ == "__main__":
    ...
    goods_client.call(4, 0, 1)
    goods_client.call(5, 0, 1)
    goods_client.call(6, 0, 1)
    goods_client.call(7, 0, 1)
    goods_client.call(8, 0, 1)
    goods_client.call(9, 0, 1)
    goods_client.call(10, 0, 1)
