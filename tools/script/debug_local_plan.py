...
if __name__ == "__main__":
    ...
    # 格式(位置,分数,东西)
    goods_client.call(0, 1, 0)
    goods_client.call(1, 1, 0)
    goods_client.call(2, 2, 0)
    goods_client.call(3, 3, 0)
    goods_client.call(4, 0, 0)
    goods_client.call(5, 0, 0)
    goods_client.call(6, 0, 0)
    goods_client.call(7, 0, 12)
